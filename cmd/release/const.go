...
var components = map[string]component{
	...
	"tenancy-operator":            {"tenancy-operator/v", "tenancy-operator.yml: builds + signs the image, cuts a GitHub release, publishes SBOM + signed OCM component (chart lives in-repo, no chart bump)"},
