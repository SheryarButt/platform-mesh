...
// Code generated by openapi-gen-d427ff9ee9ad05f5da435abbb7c5929cb713ac56. DO NOT EDIT.
...
func schema_goplatform_meshio_apis_tenancy_v1alpha1_Membership(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("go.platform-mesh.io/apis/tenancy/v1alpha1.MembershipSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("go.platform-mesh.io/apis/tenancy/v1alpha1.MembershipStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"go.platform-mesh.io/apis/tenancy/v1alpha1.MembershipSpec", "go.platform-mesh.io/apis/tenancy/v1alpha1.MembershipStatus", v1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_goplatform_meshio_apis_tenancy_v1alpha1_MembershipIndexEntry(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "MembershipIndexEntry is one Membership the user holds, with enough Tenant and Project metadata for a client to render it without extra lookups.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"tenantUUID": {
						SchemaProps: spec.SchemaProps{
							Description: "TenantUUID is the Tenant's metadata.name.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"tenantDisplayName": {
						SchemaProps: spec.SchemaProps{
							Description: "TenantDisplayName mirrors Tenant.spec.displayName, re-synced when it changes.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"tenantCreatedAt": {
						SchemaProps: spec.SchemaProps{
							Description: "TenantCreatedAt mirrors the Tenant's creationTimestamp.",
							Ref:         ref(v1.Time{}.OpenAPIModelName()),
						},
					},
					"tenantFirstAdmin": {
						SchemaProps: spec.SchemaProps{
							Description: "TenantFirstAdmin is the User that held the Tenant's first admin Membership.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"tenantClusterID": {
						SchemaProps: spec.SchemaProps{
							Description: "TenantClusterID is the Tenant workspace's kcp logical cluster.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"projectUUID": {
						SchemaProps: spec.SchemaProps{
							Description: "ProjectUUID is set on project-scope rows and empty on tenant-scope rows.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"projectDisplayName": {
						SchemaProps: spec.SchemaProps{
							Description: "ProjectDisplayName mirrors the display name annotation on the Project's kcp Workspace. Empty on tenant-scope rows.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"projectClusterID": {
						SchemaProps: spec.SchemaProps{
							Description: "ProjectClusterID is the Project workspace's kcp logical cluster, which is what a kubeconfig server URL points at. Empty on tenant-scope rows.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"role": {
						SchemaProps: spec.SchemaProps{
							Description: "Role is the granted role.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"personal": {
						SchemaProps: spec.SchemaProps{
							Description: "Personal mirrors Tenant.spec.personal.",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
				},
				Required: []string{"tenantUUID", "role"},
			},
		},
		Dependencies: []string{
...
func schema_goplatform_meshio_apis_tenancy_v1alpha1_MembershipList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "MembershipList is a list of Membership resources.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("go.platform-mesh.io/apis/tenancy/v1alpha1.Membership"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"go.platform-mesh.io/apis/tenancy/v1alpha1.Membership", v1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_goplatform_meshio_apis_tenancy_v1alpha1_MembershipSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"scope": {
						SchemaProps: spec.SchemaProps{
							Description: "Scope selects what this Membership grants access to.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"project": {
						SchemaProps: spec.SchemaProps{
							Description: "Project is the UUID of the target Project. Required when scope=project, and must be empty otherwise.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"role": {
						SchemaProps: spec.SchemaProps{
							Description: "Role is the privilege level granted in the target.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
...
func schema_goplatform_meshio_apis_tenancy_v1alpha1_MembershipStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "MembershipStatus defines the observed state of a Membership.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"clusterID": {
						SchemaProps: spec.SchemaProps{
							Description: "ClusterID is the kcp logical cluster the RBAC for this Membership was written into.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"conditions": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "Conditions describe the current state.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
...
func schema_goplatform_meshio_apis_tenancy_v1alpha1_Project(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Project is where tenant work happens. It is the tenant-facing handle for a kcp Workspace; the Workspace object itself is never exposed.\n\nProjects are a flat list under their Tenant — there are no sub-projects. Access to one Project grants nothing anywhere else. Grouping is left to a future Folder kind between Tenant and Project, so Project stays a leaf.\n\nmetadata.name is a server-assigned UUID and is also the workspace name, so renaming (spec.displayName) never moves a path.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("go.platform-mesh.io/apis/tenancy/v1alpha1.ProjectSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("go.platform-mesh.io/apis/tenancy/v1alpha1.ProjectStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"go.platform-mesh.io/apis/tenancy/v1alpha1.ProjectSpec", "go.platform-mesh.io/apis/tenancy/v1alpha1.ProjectStatus", v1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_goplatform_meshio_apis_tenancy_v1alpha1_ProjectList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ProjectList is a list of Project resources.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("go.platform-mesh.io/apis/tenancy/v1alpha1.Project"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"go.platform-mesh.io/apis/tenancy/v1alpha1.Project", v1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_goplatform_meshio_apis_tenancy_v1alpha1_ProjectSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ProjectSpec defines the desired state of a Project.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"displayName": {
						SchemaProps: spec.SchemaProps{
							Description: "DisplayName is the human-facing label. Not unique, and changing it never moves the workspace path.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_goplatform_meshio_apis_tenancy_v1alpha1_ProjectStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ProjectStatus defines the observed state of a Project.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"clusterID": {
						SchemaProps: spec.SchemaProps{
							Description: "ClusterID is the kcp logical cluster of this Project's workspace. Clients address the workspace by cluster ID, not by path.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"workspacePath": {
						SchemaProps: spec.SchemaProps{
							Description: "WorkspacePath is the full kcp path of this Project's workspace.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_goplatform_meshio_apis_tenancy_v1alpha1_Tenant(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Tenant is the membership and billing boundary. It owns a kcp workspace of type `tenant` holding this Tenant's Memberships; actual work happens in the Projects beneath it.\n\nmetadata.name is server-assigned and is also the workspace name; spec.displayName is metadata only and is not unique.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("go.platform-mesh.io/apis/tenancy/v1alpha1.TenantSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("go.platform-mesh.io/apis/tenancy/v1alpha1.TenantStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"go.platform-mesh.io/apis/tenancy/v1alpha1.TenantSpec", "go.platform-mesh.io/apis/tenancy/v1alpha1.TenantStatus", v1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_goplatform_meshio_apis_tenancy_v1alpha1_TenantList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "TenantList is a list of Tenant resources.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("go.platform-mesh.io/apis/tenancy/v1alpha1.Tenant"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"go.platform-mesh.io/apis/tenancy/v1alpha1.Tenant", v1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_goplatform_meshio_apis_tenancy_v1alpha1_TenantSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"personal": {
						SchemaProps: spec.SchemaProps{
							Description: "Personal marks the Tenant auto-created for a single User at bootstrap. Immutable, and not counted against the per-User tenant quota.",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
					"projectCreation": {
						SchemaProps: spec.SchemaProps{
							Description: "ProjectCreation controls who may create Projects.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"providersMetadataCreation": {
						SchemaProps: spec.SchemaProps{
							Description: "ProvidersMetadataCreation controls who may publish Tenant-private provider metadata. Same enum and default as ProjectCreation.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"projectQuota": {
						SchemaProps: spec.SchemaProps{
							Description: "ProjectQuota caps the number of Projects. 0 means use the platform default.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
...
func schema_goplatform_meshio_apis_tenancy_v1alpha1_TenantStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"workspacePath": {
						SchemaProps: spec.SchemaProps{
							Description: "WorkspacePath is the path of the materialized kcp Workspace — <tenant-fleet-root>:<metadata.name>. Set once the workspace exists.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"clusterID": {
						SchemaProps: spec.SchemaProps{
							Description: "ClusterID is the kcp logical cluster behind WorkspacePath.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"firstAdmin": {
						SchemaProps: spec.SchemaProps{
							Description: "FirstAdmin is the User that was given the first admin Membership.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_goplatform_meshio_apis_tenancy_v1alpha1_User(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "User is the record of an identity that has authenticated at least once.\n\nmetadata.name is sha256(issuer + \"\\n\" + sub), so self-provision is idempotent: two concurrent creates for one identity collide on AlreadyExists.\n\nA new identity provisions itself by creating its own User with an empty spec; the server fills every field from the verified token.\n\nA User is a record, not a credential and not an authorization input. Deleting it does not stop the token authenticating — kcp RBAC decides that.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("go.platform-mesh.io/apis/tenancy/v1alpha1.UserSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("go.platform-mesh.io/apis/tenancy/v1alpha1.UserStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"go.platform-mesh.io/apis/tenancy/v1alpha1.UserSpec", "go.platform-mesh.io/apis/tenancy/v1alpha1.UserStatus", v1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_goplatform_meshio_apis_tenancy_v1alpha1_UserList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("go.platform-mesh.io/apis/tenancy/v1alpha1.User"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"go.platform-mesh.io/apis/tenancy/v1alpha1.User", v1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_goplatform_meshio_apis_tenancy_v1alpha1_UserMembershipIndex(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "UserMembershipIndex is a flat list of the Tenants and Projects one User belongs to. One exists per User, sharing its metadata.name.\n\nIt is a read model, so a client can list its tenants and projects without fanning out over the fleet. It is not consulted when a tenant talks to their own workspace — kcp RBAC decides that. If the two disagree, RBAC is right and the index needs rebuilding.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("go.platform-mesh.io/apis/tenancy/v1alpha1.UserMembershipIndexSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("go.platform-mesh.io/apis/tenancy/v1alpha1.UserMembershipIndexStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"go.platform-mesh.io/apis/tenancy/v1alpha1.UserMembershipIndexSpec", "go.platform-mesh.io/apis/tenancy/v1alpha1.UserMembershipIndexStatus", v1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_goplatform_meshio_apis_tenancy_v1alpha1_UserMembershipIndexList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "UserMembershipIndexList is a list of UserMembershipIndex resources.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("go.platform-mesh.io/apis/tenancy/v1alpha1.UserMembershipIndex"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"go.platform-mesh.io/apis/tenancy/v1alpha1.UserMembershipIndex", v1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_goplatform_meshio_apis_tenancy_v1alpha1_UserMembershipIndexSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "UserMembershipIndexSpec defines the desired state of a UserMembershipIndex.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"entries": {
						VendorExtensible: spec.VendorExtensible{
						...
						SchemaProps: spec.SchemaProps{
							Description: "Entries carries one row per Membership the User holds, across every Tenant and Project.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
...
func schema_goplatform_meshio_apis_tenancy_v1alpha1_UserMembershipIndexStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "UserMembershipIndexStatus defines the observed state of a UserMembershipIndex.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"entryCount": {
						SchemaProps: spec.SchemaProps{
...
func schema_goplatform_meshio_apis_tenancy_v1alpha1_UserSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "UserSpec defines the desired state of a User.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"email": {
						SchemaProps: spec.SchemaProps{
							Description: "Email is taken from the verified id_token. Informational only; RBACIdentity is what kcp RBAC joins on.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"name": {
						SchemaProps: spec.SchemaProps{
							Description: "Name is the human-facing display name from the id_token.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"issuer": {
						SchemaProps: spec.SchemaProps{
							Description: "Issuer is the OIDC issuer that authenticated this identity.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"subject": {
						SchemaProps: spec.SchemaProps{
							Description: "Subject is the raw `sub` claim. Together with Issuer it is what metadata.name hashes.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"rbacIdentity": {
						SchemaProps: spec.SchemaProps{
							Description: "RBACIdentity is the username kcp sees after OIDC extraction, and the subject every ClusterRoleBinding the controller writes will name.\n\nIt mirrors kcp's own username configuration and must be computed from it, never hardcoded. If the two disagree, bindings name a subject that never authenticates and the user is silently denied.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"tenantQuota": {
						SchemaProps: spec.SchemaProps{
							Description: "TenantQuota overrides the platform default cap on how many Tenants this User may create. 0 means use the platform default. Personal Tenants do not count against it. Settable only by a platform admin.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					"tenancy": {
						SchemaProps: spec.SchemaProps{
							Description: "Tenancy says what the platform should provision for this identity.\n\nThe whole object carries a default, not just the fields inside it: structural defaulting only descends into objects that are present, so a client omitting `tenancy` would otherwise get everything as false.",
							Default:     map[string]interface{}{},
							Ref:         ref("go.platform-mesh.io/apis/tenancy/v1alpha1.UserTenancySpec"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"go.platform-mesh.io/apis/tenancy/v1alpha1.UserTenancySpec"},
	}
}

func schema_goplatform_meshio_apis_tenancy_v1alpha1_UserStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "UserStatus defines the observed state of a User.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"active": {
						SchemaProps: spec.SchemaProps{
							Description: "Active reports whether this identity may still use the platform's own surfaces. Not an RBAC input.",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
					...
					"defaultTenant": {
						SchemaProps: spec.SchemaProps{
							Description: "DefaultTenant is the UUID of the Tenant seeded for this User at bootstrap.\n\nIt records that seeding happened; it is never cleared and never re-seeded if the User deletes that Tenant. \"Default\" means what was seeded, not somewhere requests go — it is not an access-control or request-scoping input.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"defaultProject": {
						SchemaProps: spec.SchemaProps{
							Description: "DefaultProject is the UUID of the first Project seeded inside DefaultTenant. Same meaning as DefaultTenant: a one-time record.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_goplatform_meshio_apis_tenancy_v1alpha1_UserTenancySpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "UserTenancySpec says what to bootstrap for one User. The operator's --tenancy-personal-tenants-enabled flag can turn seeding off fleet-wide, but never on for a User that asked for it to be off.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"seedTenant": {
						SchemaProps: spec.SchemaProps{
							Description: "SeedTenant creates a personal Tenant for this User. When false, the User is expected to be invited into someone else's Tenant instead.\n\nOne-shot: it runs only while status.defaultTenant is empty. Deleting the Tenant, or toggling this field, does not re-run it.",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
					"seedProject": {
						SchemaProps: spec.SchemaProps{
							Description: "SeedProject creates a first Project inside the personal Tenant, so a new identity lands somewhere it can work.\n\nIgnored when SeedTenant is false — there is nowhere to put the Project. One-shot on status.defaultProject, the same way SeedTenant is.\n\nThis does not make that Project a default: nothing scopes requests to it.",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
